...
try:
    ...
    raise ImportError("mlx_openai_server must be installed to use mlx-openai-server-hub") from exc
...
from mlx_openai_server_hub.utils.network import is_port_available
